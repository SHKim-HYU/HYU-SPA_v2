...
void robot::robot_update_R(void)
{
	...
	*/
	...
	L[4] << 0, BASE_Y - LINK_12, BASE_Z - LINK_23 - LINK_34 - LINK_45 - LINK_56;
	L[5] << 0, BASE_Y - LINK_12, BASE_Z - LINK_23 - LINK_34 - LINK_45 - LINK_56; //If want to compare FK or Jacobian of KDL Lib, it needs to remove the LINK56
	//L[5] << 0, LINK_6e, 0;

	CoM[0] << 0.00255,     BASE_Y - 0.04684,                                                   BASE_Z - 0.00039;
	CoM[1] << 0.00093,     BASE_Y - LINK_12 - 0.00217,                                         BASE_Z - 0.08254;
	CoM[2] << -0.00092,    BASE_Y - LINK_12 - LINK_23 + 0.00049,                               BASE_Z - 0.11495;
	CoM[3] << -0.00206,    BASE_Y - LINK_12 - LINK_23 - LINK_34 -  0.00034,                    BASE_Z - 0.08047;
	CoM[4] << 0.00002,     BASE_Y - LINK_12 - LINK_23 - LINK_34 - LINK_45 - 0.00084,           BASE_Z - 0.11414;
    CoM[4] << 0.00222,     BASE_Y - LINK_12 - LINK_23 - LINK_34 - LINK_45 - LINK_56 + 0.00091, BASE_Z - 0.00853;
